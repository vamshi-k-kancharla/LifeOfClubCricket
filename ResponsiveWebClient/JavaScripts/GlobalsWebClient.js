...
var GlobalWebClientModule = (function () {
    ...
    // Signup Request Record Data

    var signupRequest_RecordData_Keys = ["SignupRequest_Id", "Team_Id", "Signer_Name", "Current_Status"];
    var signupRequest_RecordData_RequiredKeys = ["SignupRequest_Id", "Team_Id", "Signer_Name", "Current_Status"];

    var signupRequest_RecordKeys_ForDisplay = ["SignupRequest_Id", "Team_Id", "Signer_Name", "Current_Status"];


    // Team Search & SignUp Form Input Data

    var teamSearch_FormInputData_InputLabels = ["Location"];
    var teamSearch_FormInputData_InputIds = ["TeamSearch_Place"];
    var teamSearch_FormInputData_InputTypes = ["select"];
    var teamSearch_FormInputData_SelectInputInvokeFunctions = [null];
    ...
    return {
        ...
        teamSearch_FormInputData_InputLabels : teamSearch_FormInputData_InputLabels,
        teamSearch_FormInputData_InputIds : teamSearch_FormInputData_InputIds,
        teamSearch_FormInputData_InputTypes : teamSearch_FormInputData_InputTypes,
        teamSearch_FormInputData_SelectInputInvokeFunctions : teamSearch_FormInputData_SelectInputInvokeFunctions,
    
        signupRequest_RecordData_Keys : signupRequest_RecordData_Keys,
        signupRequest_RecordData_RequiredKeys : signupRequest_RecordData_RequiredKeys,

        signupRequest_RecordKeys_ForDisplay : signupRequest_RecordKeys_ForDisplay,
