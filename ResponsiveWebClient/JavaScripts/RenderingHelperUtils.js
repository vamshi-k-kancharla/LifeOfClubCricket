...
var RenderingHelperUtilsModule = (function () {
     ...
     * @param {int} bInputLabel  : Follow up action Button Label
     *
     */

     // ToDo : Updated the Function to be Generic. Rename and update the callers.

     function addDualChallengerDetailContainer(mainContentWindowId, containerNumber,
         dualChallengerDetailAlignment, numOfDetails, bChallenge = true, bInputLabel = null, bActionInvokeFunction = null) {
        ...
        var containerNode = createNewElementWithAttributes("DIV", containerId, "col-sm-12", null);
        {
            ...
            if( bChallenge == true ) {
                ...
                var actionDetailNode = createNewElementWithAttributes("DIV", containerId + "_ActionDetailNode", "col-sm-3", null);
                {
                    ...
                    (bActionInvokeFunction == null) ? 
                    "DualChallenger_UpdateUtilsModule.updateDualChallengerRecordFromUserInput( " : bActionInvokeFunction +
                        "'containerNode" + containerNumber.toString() + "')");

                    actionNode.innerHTML = (bInputLabel == null) ? "Accept Challenge" : bInputLabel;
