...
http.createServer(function (http_request, http_response) {
    ...
    if (webClientRequest == "UserRegistration" || webClientRequest == "UserAuthentication" ||
        ...
        // Connect to "LifeOfClubCricket" db for "Budget Related CRUD operations"
        ...
        // Connect to "LifeOfClubCricket" db for "Expense Related CRUD operations"
        ...
        // Connect to "LifeOfClubCricket" db for "Budget Analytics CRUD Operations"
        ...
        globalsForServiceModule.mongoClient.connect(globalsForServiceModule.mongoLifeOfClubCricketDbUrl, function (err, db) {
            ...
            if (err != null) {
                ...
                console.error("LifeOfClubCricketWebService.createServer : " +
                    "Server Error while connecting to LifeOfClubCricket mongo db :" + globalsForServiceModule.mongoLifeOfClubCricketDbUrl);

                var failureMessage = "LifeOfClubCricketWebService.createServer : " +
                    "Server Error while connecting to LifeOfClubCricket mongo db :" + globalsForServiceModule.mongoLifeOfClubCricketDbUrl;
                ...
                globalsForServiceModule.LifeOfClubCricketDbConnection = db.db(globalsForServiceModule.LifeOfClubCricket_Database_Name);

                handleBudgetAnalyticsDatabaseRequests(webClientRequest, clientRequestWithParamsMap, http_response);

                console.log("Successfully connected to LifeOfClubCricket Details MongoDb : " +
...
function handleBudgetDatabaseRequests(webClientRequest, clientRequestWithParamsMap, http_response) {
    ...
    globalsForServiceModule.mongoClient.connect(globalsForServiceModule.mongoLifeOfClubCricketDbUrl, function (err, db) {
        ...
        if (err != null) {
            ...
            console.error("LifeOfClubCricketWebService.createServer : Server Error while connecting to BudgetDetails mongo db on local server :"
                + globalsForServiceModule.mongoLifeOfClubCricketDbUrl);

            var failureMessage = "LifeOfClubCricketWebService.createServer : Server Error while connecting to BudgetDetails mongo db on local server :"
                + globalsForServiceModule.mongoLifeOfClubCricketDbUrl;
            HelperUtilsModule.logInternalServerError("LifeOfClubCricketWebService.createServer", failureMessage, http_response);
            ...
            console.log("Successfully connected to BudgetDetails MongoDb : " + globalsForServiceModule.mongoLifeOfClubCricketDbUrl);

            // Database Creation

            console.log("Creating / Retrieving BudgetDetails Database : ");
            dbConnection_BudgetDetails_Database = db.db(globalsForServiceModule.LifeOfClubCricket_Database_Name);
            ...
            dbConnection_BudgetDetails_Database.createCollection(globalsForServiceModule.budgetDetails_Table_Name, function (err, result) {
                ...
                if (err) {
                    ...
                    console.error("LifeOfClubCricketWebService.createServer : Error while creating / retrieving Collection ( Table ) in Budget Details mongoDb : "
                        + globalsForServiceModule.budgetDetails_Table_Name);

                    var failureMessage = "LifeOfClubCricketWebService.createServer : Error while creating / retrieving Collection ( Table ) in Budget Details mongoDb : "
                        + globalsForServiceModule.budgetDetails_Table_Name;
                    HelperUtilsModule.logInternalServerError("LifeOfClubCricketWebService.createServer", failureMessage, http_response);
                ...
                switch (webClientRequest) {
                    ...
                    case "AddBudget":
                        ...
                        console.log("LifeOfClubCricketWebService.createServer : Successfully placed Add Budget Record call");
                    ...
                    case "UpdateBudget":
                        ...
                        console.log("LifeOfClubCricketWebService.createServer : Successfully placed Update Budget Record call");

                        break;

                    case "RetrieveBudgetDetails":

                        console.log("LifeOfClubCricketWebService.createServer : Inside Budget Details Switch : " +
                    ...
                    case "RemoveBudget":
                        ...
                        console.log("LifeOfClubCricketWebService.createServer : Successfully placed Remove Budget Record call");
...
function handleExpensesDatabaseRequests(webClientRequest, clientRequestWithParamsMap, http_response) {
    ...
    globalsForServiceModule.mongoClient.connect(globalsForServiceModule.mongoLifeOfClubCricketDbUrl, function (err, db) {
        ...
        if (err != null) {
            ...
            console.error("LifeOfClubCricketWebService.createServer : Server Error while connecting to ExpenseDetails mongo db on local server :"
                + globalsForServiceModule.mongoLifeOfClubCricketDbUrl);

            var failureMessage = "LifeOfClubCricketWebService.createServer : Server Error while connecting to ExpenseDetails mongo db on local server :"
                + globalsForServiceModule.mongoLifeOfClubCricketDbUrl;
            HelperUtilsModule.logInternalServerError("LifeOfClubCricketWebService.createServer", failureMessage, http_response);
            ...
            console.log("Successfully connected to ExpenseDetails MongoDb : " + globalsForServiceModule.mongoLifeOfClubCricketDbUrl);

            // Database Creation

            console.log("Creating / Retrieving ExpenseDetails Database : ");
            dbConnection_ExpenseDetails_Database = db.db(globalsForServiceModule.LifeOfClubCricket_Database_Name);
            ...
            dbConnection_ExpenseDetails_Database.createCollection(globalsForServiceModule.expenseDetails_Table_Name, function (err, result) {
                ...
                if (err) {
                    ...
                    console.error("LifeOfClubCricketWebService.createServer : Error while creating / retrieving Collection ( Table ) in Expense Details mongoDb : "
                        + globalsForServiceModule.expenseDetails_Table_Name);

                    var failureMessage = "LifeOfClubCricketWebService.createServer : Error while creating / retrieving Collection ( Table ) in Expense Details mongoDb : "
                        + globalsForServiceModule.expenseDetails_Table_Name;
                    HelperUtilsModule.logInternalServerError("LifeOfClubCricketWebService.createServer", failureMessage, http_response);
                ...
                switch (webClientRequest) {
                    ...
                    case "AddExpense":
                        ...
                        console.log("LifeOfClubCricketWebService.createServer : Successfully placed Add Expense Record call");
                    ...
                    case "AddExpensesThroughFile":
                        ...
                        console.log("LifeOfClubCricketWebService.createServer : Successfully placed AddExpenseRecords_ThroughFile call");
                    ...
                    case "UpdateExpense":
                        ...
                        console.log("LifeOfClubCricketWebService.createServer : Successfully placed Update Expense Record call");

                        break;

                    case "RetrieveExpenseDetails":

                        console.log("LifeOfClubCricketWebService.createServer : Inside Expense Details Switch : " +
                    ...
                    case "RemoveExpense":
                        ...
                        console.log("LifeOfClubCricketWebService.createServer : Successfully placed Remove Expense Record call");
...
function handleBudgetAnalyticsDatabaseRequests(webClientRequest, clientRequestWithParamsMap, http_response) {
    ...
    globalsForServiceModule.LifeOfClubCricketDbConnection.createCollection(globalsForServiceModule.budgetAnalytics_TableName,
        function (err, result) {
        ...
        switch (webClientRequest) {
            ...
            case "RetrieveBudgetAnalytics":
                ...
                console.log("LifeOfClubCricketWebService.createServer : Inside Budget Analytics Switch : " +
                    "RetrieveBudgetAnalytics : Budget_Id : " + clientRequestWithParamsMap.get("Budget_Id"));

                // DB query & Reponse Building

                BudgetAnalyticsQueryModule.retrieveRecordFromBudgetAnalyticsDatabase(globalsForServiceModule.LifeOfClubCricketDbConnection,
                    globalsForServiceModule.budgetAnalytics_TableName,
                    clientRequestWithParamsMap,
...
function handleFileUploadRequests(webClientRequest, clientRequestWithParamsMap, http_response) {
    ...
    switch (webClientRequest) {
        ...
        case "CustomUploadFile":
            ...
            console.log("LifeOfClubCricketWebService.handleFileUploadRequests : Uploaded File : " + clientRequestWithParamsMap.get("FileName"));
            ...
            fileSystem.writeFile(globalsForServiceModule.expenseFilesUploadDirectory + clientRequestWithParamsMap.get("FileName"),
                ...
                function (err) {
                    ...
                    if (err) {
                        ...
                        console.error("LifeOfClubCricketWebService.handleFileUploadRequests : Error while creating recently uploaded file: "
                            + clientRequestWithParamsMap.get("FileName"));

                        var failureMessage = "LifeOfClubCricketWebService.handleFileUploadRequests: Error while creating recently uploaded file: "
                            + clientRequestWithParamsMap.get("FileName");
                        HelperUtilsModule.logInternalServerError("LifeOfClubCricketWebService.handleFileUploadRequests",
                        ...
                        console.error("LifeOfClubCricketWebService.handleFileUploadRequests : Successfully created new file: "
                            + clientRequestWithParamsMap.get("FileName"));

                        var successMessage = "LifeOfClubCricketWebService.handleFileUploadRequests: Successfully created new file: "
                            + clientRequestWithParamsMap.get("FileName");
                        HelperUtilsModule.buildSuccessResponse_Generic("LifeOfClubCricketWebService.handleFileUploadRequests",
        ...
        default:
            ...
            console.error("LifeOfClubCricketWebService.handleFileUploadRequests : Inappropriate WebClient Request received...exiting");
